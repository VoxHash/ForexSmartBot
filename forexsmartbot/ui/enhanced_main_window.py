...
class StrategyConfigWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        strategy_layout.addRow(f"{self.tr('risk_per_trade', 'Risk per Trade')}:", self.risk_spinbox)
                ...
                for i in range(form_layout.rowCount()):
                    ...
                    if label_item and label_item.widget():
                        ...
                        if text == "Strategy:":
                            ...
                            label.setText(language_manager.tr("risk_per_trade", "Risk per Trade:"))
                        elif text == "Leverage:":
...
class OpenPositionsWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        self.positions_table.setHorizontalHeaderLabels([
            ...
            self.tr("current_price", "Current Price"), 
