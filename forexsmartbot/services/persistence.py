...
class SettingsManager:
    ...
    def _load_settings(self) -> Dict[str, Any]:
        ...
        if os.getenv("MT4_ZMQ_HOST"):
            default_settings["mt4_host"] = os.getenv("MT4_ZMQ_HOST", "127.0.0.1")
        if os.getenv("MT4_ZMQ_PORT"):
            default_settings["mt4_port"] = int(os.getenv("MT4_ZMQ_PORT", "5555"))
